...
<!--@HomePage: https://github.com/PrettiestFairy-->
...
# @HomePage: https://github.com/PrettiestFairy
# @OperatingSystem: Windows 11 Professional Workstation 23H2 Canary Channel
# @CreatedTime: ${YEAR}-${MONTH}-${DAY}apiVersion: v1
kind: ConfigMap
metadata:
  name: #[[$Title$]]#
data:
...
@OperatingSystem: Windows 11 Professional 23H2
@CreatedTime: ${YEAR}-${MONTH}-${DAY}
"""
...
> @Editor: ${PRODUCT_NAME}  
> @Author: [Lionel Johnson (From Chengdu.China)](https://fairy.host)  
> @HomePage: [Lionel Johnson](https://github.com/PrettiestFairy)  
> @OperatingSystem: Windows 11 Professional Workstation 23H2 Canary Channel  
> @CreatedTime: ${YEAR}-${MONTH}-${DAY}  
